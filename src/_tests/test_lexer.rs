use crate::{CharPos, Pos, Token, TokenKind, read_keyword_or_identifier, skip_ws, tokenize};
...
fn test_tokenize() {
    ...
    assert_eq!(toks[0], Token::new(TokenKind::Fn, Pos::new(1, 1, 0)));
    assert_eq!(toks[1], Token::new(TokenKind::LParen, Pos::new(2, 1, 3)));
    assert_eq!(toks[2], Token::new(TokenKind::LCurly, Pos::new(2, 2, 4)));
    assert_eq!(
        toks[3],
        Token::new(
    ...
    assert_eq!(toks[4], Token::new(TokenKind::RCurly, Pos::new(2, 13, 15)));
    assert_eq!(toks[5], Token::new(TokenKind::RParen, Pos::new(2, 14, 16)));
}
...
fn test_tokenizer_over_raw_identifier() {
    ...
    assert_eq!(
        toks.unwrap(),
        [
            Token::new(TokenKind::Identifier("r".to_string()), Pos::new(1, 1, 0)),
            Token::new(TokenKind::Identifier("r#".to_string()), Pos::new(1, 3, 2)),
            Token::new(TokenKind::Identifier("r#aw".to_string()), Pos::new(1, 6, 5)),
        ]
    );
}
